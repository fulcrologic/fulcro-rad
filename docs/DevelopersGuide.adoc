...
sends transit, so it is not possible to query for the file *content* via a Pathom resolver. Instead you must
...
* Add the middleware to receive the HTTP posts of the temporary files.
* Add the save middleware to handle post-processing of files on form save.
