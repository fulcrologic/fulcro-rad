...
In RAD 1.6.5 another middleware was introduced: autojoin. This middleware is used in the case where you
want to create or edit an entity that MUST have a parent, but you simply want to specify the parent
on form start instead of having to make the parent form with subforms in order to work with the children.
