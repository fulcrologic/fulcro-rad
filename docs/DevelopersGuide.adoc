...
of interest from your database. Typically you'll have one
...
their ID. Most db adapters can automatically generate these resolvers.
...
See the documentation for the database adapters for instructions.
